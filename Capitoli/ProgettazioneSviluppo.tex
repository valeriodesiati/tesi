...
Successivamente si trova un \mintinline{java}{EntityManager} utilizzato l'interazione con il Database ed è parte del modulo Spring Data JPA.\\
...
vengono restituiti quattro risultati, i primi tre impostati a \mintinline{lua}{nil} (rappresentano i campi del token) e il quarto come stringa con un messaggio di errore.\\

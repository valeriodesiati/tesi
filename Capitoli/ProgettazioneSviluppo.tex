...
\section{Architettura del progetto}\label{sec:architetturaprogetto}
...
Il microservizio che è stato realizzato serve a verificare l'avvenuto acquisto di un modulo applicativo da parte di un utente, identificato, per ora, da un indirizzo e-mail.\\
Per lo sviluppo del microservizio è stato deciso di utilizzare il linguaggio di programmazione Java ed il framework Spring.\\

...
% 	\hhline{|-|-|}
% 	\textbf{Settimana} & \textbf{Attività svolte} \\ \hhline{|-|-|}
% 	Prima settimana & \begin{tabular}[c]{@{}c@{}}Esposizione delle specifiche del progetto.\\ Acquisizione delle competenze preliminari necessarie\\ quali Git e metodologia di sviluppo Agile.\end{tabular} \\ \hhline{|-|-|}
% 	Seconda settimana & \begin{tabular}[c]{@{}c@{}}Studio del framework Spring.\\ Sviluppo del microservizio.\end{tabular} \\ \hhline{|-|-|}
% 	Terza settimana & Sviluppo del microservizio. \\ \hhline{|-|-|}
% 	Quarta settimana & \begin{tabular}[c]{@{}c@{}}Testing del microservizio.\\ Studio del funzionamento di Kong Gateway.\\ Configurazione Kong Gateway.\end{tabular} \\ \hhline{|-|-|}
% 	Quinta settimana & \begin{tabular}[c]{@{}c@{}}Studio delle specifiche del plugin.\\ Studio della sintassi e della semantica del linguaggio Lua.\\ Sviluppo del plugin per Kong Gateway.\\ Testing del prodotto finito.\end{tabular} \\ \hhline{|-|-|}
% 	\end{tabularx}
% 	%\end{tabular}
...
\begin{table}[ht]
	...
	\resizebox{1.0\linewidth}{!}{
		\begin{tabular}{|c|c|}
			...
			\hhline{|-|-|}
			Acquisizione delle competenze preliminari necessarie & 38 \cr quali Git e metodologia di sviluppo Agile & \\
			\hhline{|-|-|}
			...
			\hhline{|-|-|}
			Studio della sintassi e della semantica & 12 \cr del linguaggio Lua &  \\
			\hhline{|-|-|}
